...
from clicker import evaluate_sample_sam, evaluate_sample_sam2_video,evaluate_sample_sam2_video_robust
import gc
import torch
...
def main(args: argparse.Namespace) -> None:
    ...
    for video, videogt in zip(video_list, video_gt_list):
        ...
        if args.mode2 == 'single' and args.mode == 'point':
            ...
            _, gt_binary = cv2.threshold(gt, 127, 255, cv2.THRESH_BINARY)
            gt_binary = gt_binary.astype(bool)
            evaluate_sample_sam2_video_robust(gt_mask=gt, predictor=generator, max_iou_thr=0.9,
