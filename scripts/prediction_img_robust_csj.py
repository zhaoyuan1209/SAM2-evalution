...
from scripts.clicker import evaluate_sample_sam,evaluate_sample_sam_robust
import tqdm
import argparse
import json
...
def main(args: argparse.Namespace) -> None:
    ...
    for t in tqdm.tqdm(targets):
        ...
        if args.mode == 'auto':# or gt.max()==0
            ...
            final_mask,final_prob = evaluate_sample_sam_robust(image=image, gt_mask=gt, predictor=generator, max_iou_thr=0.9,
